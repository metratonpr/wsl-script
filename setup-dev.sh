...
sudo apt update
sudo apt install -y php8.2 php8.2-cli php8.2-common php8.2-curl php8.2-mbstring php8.2-xml php8.2-zip php8.2-mysql php8.2-bcmath php8.2-tokenizer php8.2-gd php8.2-intl php8.2-soap php8.2-opcache php8.2-readline php8.2-fpm php8.2-imap sudo apt-get install php-mbstring
sudo service apache2 restart  # ou sudo service php8.2-fpm restart se estiver usando FPM
